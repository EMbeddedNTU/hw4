...
class HeartrateAndButtonDemo : ble::Gap::EventHandler {
public:
    HeartrateAndButtonDemo(BLE &ble, events::EventQueue &event_queue) :
        _ble(ble),
    ...
    void start()
    {
        _ble.init(this, &HeartrateAndButtonDemo::on_init_complete);
...
private:
    ...
    void on_init_complete(BLE::InitializationCompleteCallbackContext *params)
    {
        ...
        _button.fall(Callback<void()>(this, &HeartrateAndButtonDemo::button_pressed));
        _button.rise(Callback<void()>(this, &HeartrateAndButtonDemo::button_released));
...
int main()
{
    ...
    HeartrateAndButtonDemo demo(ble, event_queue);
    demo.start();
